/*!
 * GhorePai: Front-end site library
 * @license MIT
 * Inline scripts may access the api using an async handler:
 *   var GhorePai = GhorePai || [];
 *   GhorePai.push(readyFunction);
 */
! function(t) {
    var e = {};
    ...
    d.config.hideBackface = !1, d.config.keepInherited = !0, r.define = function(t, e, n) {
        ...
        var e = window.__wf_design,
            n = void 0 !== e;
        return t ? "design" === t ? n && e : "preview" === t ? n && !e : "slug" === t ? n && window.__wf_slug : "editor" === t ? window.GhorePaiEditor : "test" === t ? window.__wf_test : "frame" === t ? window !== window.top : void 0 : n
    };
    ...
    var b, T = "resize.ghorepai orientationchange.ghorepai load.ghorepai";
    ...
    r.resize = O(c, T), r.scroll = O(c, "scroll.ghorepai resize.ghorepai orientationchange.ghorepai load.ghorepai"), r.redraw = O(), r.location = function(t) {
        window.location = t
    ...
    }, u(r.ready), A(), t.exports = window.GhorePai = r
}, function(t, e, n) {
    (function(e) {
        var n = "object",
            r = function(t) {
                                    ...
                                    a && t.forEach(function(t, i) {
                                        ...
                                        ! function(t) {
                                            var e = t.store,
                                                ...
                                                b = c.id;
                                            U(E, a) && (b = V(n, b));
                                            var T = v.hasBoundaryNodes && i ? I.getClosestElement(i, w) : null;
    ...
    function Et(t) {
        ...
        c >= m.length && (0, s.default)(h, "config.loop") && (c = 0), 0 === c && b && c++;
        var T = (0 === c || 1 === c && b) && (0, _.isQuickEffect)(null === (e = h.action) || void 0 === e ? void 0 : e.actionTypeId) ? h.config.delay : void 0,
    ...
    n(121), n(123), n(13), n(125), n(315), n(316), n(317), n(318), n(319), n(324), n(325), t.exports = n(326)
}, function(t, e, n) {
    "use strict";
    var r = n(3);
    ...
    var r = window.$,
        i = n(65) && r.tram;
    /*!
     * GhorePai._ (aka) Underscore.js 1.6.0 (custom build)
     * _.each
     * _.map
     * _.find
     * _.filter
    ...
    e.IX2_ID_DELIMITER = "|";
    e.WF_PAGE = "data-ghorepai-page";
    e.W_MOD_JS = "gp-mod-js";
    e.W_MOD_IX = "gp-mod-ix";
    e.BOUNDARY_SELECTOR = ".gp-dyn-item";
    ...
    e.createPluginInstance = function(t) {
        var e = window.GhorePai.require("lottie").createInstance(t);
    ...
    e.clearPlugin = function(t) {
        window.GhorePai.require("lottie").createInstance(t).stop()
    }
}, function(t, e, n) {
    "use strict";
    var r, i, o, a = n(0),
    ...
    function yt(t) {
        ...
        if (C ? (A = R.limitAffectedElements, S = N, x = u(R)) : S = x = u({
            ...
            var L = r && (x || !0 === O) ? [r] : c(N);
            if (x) {
                if (O === U) return c(x).filter(function(t) {
        ...
        b = function(t, e) {
            ...
            for (var w = 0, A = i.length; w < A; w++) {
                ...
                if (0 === w && (E = R[0]), O >= x) {
                    ...
                    var C = i[w + 1],
                        N = C && O !== x;
                    g = N ? C.actionItems[0] : null, N && (_ = x / 100, m = (C.keyframe - x) / 100)
                }
            }
            var L = {};
            if (E && !g)
    ...
    r.define("dropdown", t.exports = function(t, e) {
        ...
        function S(e, i) {
            ...
            var E = R(s, a);
            n && s.el.on(O, function(t) {
                return function(e, n) {
                    n = n || {}, x(t), !0 === n.open && C(t), !1 === n.open && N(t, {
                        immediate: !0
                    })
                }
            }(s)), n || (f && (s.hovering = !1, N(s)), s.config.hover && s.toggle.on(y, function(t) {
                return function() {
                    t.hovering = !0, C(t)
                }
            }(s)), s.el.on(T, E), s.el.on(_, function(t) {
                return function(e) {
            ...
            }(s)), s.toggle.on(b, E), s.toggle.on(_, function(t) {
                var e = R(t, a);
                return function(r) {
                    if (!n && !l) {
            ...
            }(s)), s.nav = s.el.closest(".w-nav"), s.nav.on(T, E))
        }
        ...
        function C(e) {
            if (!e.open) {
                ...
                var i = r.env("editor");
                n || w.on(b, e.mouseUpOutside), e.hovering && !i && e.el.on(I, e.mouseLeave), e.hovering && i && w.on(m, e.mouseMoveOutside), window.clearTimeout(e.delayId)
            }
        }
        ...
        function N(t) {
            ...
            if (t.open && (!t.config.hover || !t.hovering || r)) {
                ...
                var i = t.config;
                if (h.outro(0, t.el[0]), w.off(b, t.mouseUpOutside), w.off(m, t.mouseMoveOutside), t.el.off(I, t.mouseLeave), window.clearTimeout(t.delayId), !i.delay || n) return t.complete();
    ...
    r.define("slider", t.exports = function(t, e) {
        ...
        function I(e, n) {
            ...
            i.el.off(v), i.left.off(v), i.right.off(v), i.nav.off(v), b(i), u ? (i.el.on("setting" + v, C(i)), R(i), i.hasTimer = !1) : (i.el.on("swipe" + v, C(i)), i.left.on("click" + v, A(i)), i.right.on("click" + v, S(i)), i.left.on("keydown" + v, w(i, A)), i.right.on("keydown" + v, w(i, S)), i.nav.on("keydown" + v, "> div", C(i)), i.config.autoplay && !i.hasTimer && (i.hasTimer = !0, i.timerCount = 1, x(i)), i.el.on("mouseenter" + v, O(i, !0, "mouse")), i.el.on("focusin" + v, O(i, !0, "keyboard")), i.el.on("mouseleave" + v, O(i, !1, "mouse")), i.el.on("focusout" + v, O(i, !1, "keyboard"))), i.nav.on("click" + v, "> div", C(i)), p || i.mask.contents().filter(function() {
            ...
            if (e.index !== e.previous) {
                if (e.ariaLiveLabel.text("Slide ".concat(o + 1, " of ").concat(i.length, ".")), "cross" === y) {
                    var w = Math.round(I - I * r.crossOver),
                        A = Math.round(I - w);
                    return T = "opacity " + w + "ms " + m, l(E).set({
                        visibility: ""
                    }).add(T).start({
                        opacity: 0
                    }), void l(h).set({
...
/**
 * ----------------------------------------------------------------------
 * GhorePai: Interactions 2.0: Init
 */
